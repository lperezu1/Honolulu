...
Honolulu_2011 <- Honolulu_2011 %>% filter(ReportType == 'Homeless') 
``` 
...
Honolulu_2013 <- Honolulu_2013  %>% filter(ReportType == 'Homeless')
``` 
...
Honolulu_2014 <-  Honolulu_Edit  %>%
  filter(YEAR =='2014') 
Honolulu_2014 <- Honolulu_2014 %>% filter(ReportType == 'Homeless') 
``` 
...
Honolulu_2015 <- Honolulu_2015 %>% filter(ReportType == 'Homeless')
``` 
...
Honolulu_2016  <- Honolulu_2016 %>% filter(ReportType == 'Homeless')
```
...
Honolulu_2017 <-  Honolulu_Edit  %>%
  filter(YEAR =='2017')
Honolulu_2017 <- Honolulu_2017  %>% filter(ReportType == 'Homeless')
```
...
Honolulu_2018 <-  Honolulu_2018 %>% filter(ReportType == 'Homeless') 
...
Honolulu_2019 <- Honolulu_2019  %>% filter(ReportType == 'Homeless')
...
Latitude and Longitude converted to census tracts - 

- Honolulu_2011 does not work as there is only one case and it is missing longitude data. 
...
coord_2012 <- Honolulu_2012 %>% 
  mutate(census_tract = apply(Honolulu_2012, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply(Honolulu_2013, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply(Honolulu_2014, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply(Honolulu_2015, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply( Honolulu_2016, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude'])))%>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply( Honolulu_2017, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply(Honolulu_2018, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
...
mutate(census_tract = apply(Honolulu_2019, 1, function(row) call_geolocator_latlon(row['latitude'], row['longitude']))) %>% rename("GEOID" = "census_tract")
```
